...
import { buttonToStack, fieldToStack } from "./blocks/controls";
...
/** Re-exported so `dsl/index.ts` and the section lowerers keep importing the
 *  button desugarer from `./blocks`. */
export { buttonToStack } from "./blocks/controls";
